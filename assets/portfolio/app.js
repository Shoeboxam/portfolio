...
export let projects = [
    ...
    },
    {
        id: 'Autobot',
        name: 'Autobot',
        children: () => m.trust('This is a self-driving car built with a raspberry PI. There are integrated sensors for tracking movement, location, and detecting objects.'),
        links: [
            {
                name: 'Repository',
